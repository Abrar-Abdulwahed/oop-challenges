        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group input-group-outline">
              ...
              <input type="hidden" type="submit" name="searchProduct">
              </form>
            </div>
          </div>
          ...
          <div class="card my-4">
                  ...
                  <h5 class="modal-close"><i class="material-icons text-success">&#10005;</i></h5>
                    ...
                    <form role="form" method="POST">
                      ...
                      <div class="text-center">
                        <button type="submit" class="btn bg-gradient-primary mt-4 mb-0" name="addProduct">Save</button>
                      </div>
                    </form>
                  </div>
                </div>
            ...
            if($msg){
              ...
              <div class="table-responsive p-0">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                  <h6 class="mb-0 text-sm"><?php echo $product['prodName'];?></h6>
                                </div>
                              </div>
                            </td>
                            <td>
                            ...
                            <td class="align-middle">
                              ...
                              <a href="#prodEdit" class="teal modal-trigger editBTN" title="Edit" data-toggle="tooltip"
                ...
                <div class="modal mymodal" id="prodEdit">
                  <div class="modal-content center" style="padding: 24px">
                    <h5 class="modal-close"><i class="material-icons text-success">&#10005;</i></h5>
                    <h4>Edit Product Form</h4>
                    <form role="form" method="POST" id="editProductForm">
                      <input type="hidden" name="prodId" id="prodId-edit">
                      <div class="input-group input-group-outline mb-3">
                        <label class="form-label"></label>
                      ...
                      <div class="input-group input-group-outline mb-3">
                        <label class="form-label"></label>
                        <textarea name="prodDesc" id="prodDesc-edit" class="form-control" cols="30" rows="5"></textarea>
                      </div>
                      <div class="text-center">
                        <button type="submit" class="btn bg-gradient-primary mt-4 mb-0" name="editProduct">Save</button>
                      </div>
                    </form>
                  </div>
                </div>
                <div class="modal mymodal" id="prodDelete">
                  <div class="modal-content center" style="padding: 24px">
                    <h5 class="modal-close"><i class="material-icons">&#10005;</i></h5>
                    <h4>Delete Product Form</h4>
                    <form role="form" class="row g-3" action="" method="POST">
                        <input type="hidden" name="prodId" id="prodId-delete">
                        <h3>Are you sure?</h3>
                        <p>Do you really want to delete these records?</p>
                        <div class="text-center">
                          <button type="submit" class="btn bg-gradient-primary mt-4 mb-0" name="deleteProduct">Delete</button>
                        </div>
                    </form>
                  </div>
                </div>
    ...
    $(document).ready(function(){
      ...
      $(".editBTN").on('click', function(e){
        ...
        $(".deleteBTN").on('click', function(e){
          e.preventDefault(e);
          $('#prodId-delete').val($(this).attr('data-id'));  
        });    
    });
  </script>
</body>
